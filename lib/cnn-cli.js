...
env.register(require.resolve('generator-cnn-cli'));
env.register(require.resolve('generator-cnn-generator'));

switch (generator) {
    case 'base':
        env.run('cnn-base', {forego: false}, function () {
            message();
        });
        break;
    ...
    case 'generator':
        env.run('cnn-base', {extend: 'cnn-generator', forego: true}, function () {
            message();
        });
        break;
